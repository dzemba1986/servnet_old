...
<table class="tables">
  <tr>
    ...
    <td >      <a href="modyfications_form.php?tryb=modyfications&con_id=<?php if(!$installation1['_socket_installation_date']) echo($connection1['id'])?>&phone_id=<?php if(!$installation2['_socket_installation_date']) echo($connection2['id'])?>">Zmień</a>
    </td>
  </tr>
</table>
</form>
