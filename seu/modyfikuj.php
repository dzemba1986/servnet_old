...
//		exit();
	...
	break;
        ...
        if($device['lokalizacja']!='11111')
	  echo"<center><a href=\"index.php?device=".$device['dev_id']."\">Drzewo urządzeń</a></center>";
	echo"<center><a href=\"modyfikuj.php?device=".$device['dev_id']."\">Edycja</a></center>";
}
